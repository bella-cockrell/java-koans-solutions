...
public class AboutStrings {
    ...
    public void newStringIsRedundant() {
        ...
        String stringReference = new String(stringInstance); // it's already a string, no need to cast
    ...
    public void newStringIsNotIdentical() {
        String stringInstance = "zero";
        String stringReference = new String(stringInstance); // it's a new instantiation
    ...
    public void stringCompare() {
        String str = "I AM a number ONE!";
        assertEquals(str.compareTo("I AM a number ONE!") == 0, true); // lexicographic comparison (value of letters)
    ...
    public void stringSubstring() {
        ...
        assertEquals(str.substring(14, 17), "ONE"); // up to but not including end index
        assertEquals(str.substring(7, str.length()), "number ONE!"); // method not property like in Python
    }
    ...
    public void stringReplace() {
        ...
        assertEquals(str.replace("I am", "She is"), "She is a number ONE!"); // doesnt mutate original string otherwise
                                                                             // would be TWO
    }

    @Koan
    public void stringBuilderCanActAsAMutableString() {
        assertEquals(new StringBuilder("one").append(" ").append("two").toString(), "one two"); // looks klunky tho
    }
    ...
    public void extraArgumentsToMessageFormatGetIgnored() {
        assertEquals(MessageFormat.format("{0} {1} {0}", "a", "b", "c"), "a b a"); // use this to prevent exception
                                                                                   // thrown
    }
