...
public class AboutInheritance {
    ...
    public void methodOverloading() {
        ...
        // but can Bob the Cow fetch? No because Cow only overrides Animal and Animal
        // doesn't have method to fetch and neither does Cow
    }
    ...
    public void methodOverloadingUsingPolymorphism() {
        ...
        // assertEquals(max.canFetch(), true);
        // error: cannot find symbol -- perhaps can override Animal method, but not add
        // new
    }
