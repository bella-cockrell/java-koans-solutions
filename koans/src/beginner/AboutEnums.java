...
public class AboutEnums {
    ...
    enum SkatSuits {
        ...
        SkatSuits(int v) { // getter for values of the enums
            value = v;
        }

        private int value; // declares if private or public
    }

    @Koan
    public void enumsWithAttributes() {
        // value is private but we still can access it. Why?
        // encapsulation? Can access private values within the same class but not
        // outside of it
        // Try moving the enum outside the AboutEnum class... What do you expect?
        // What happens?
        // error: value has private access in SkatSuits
