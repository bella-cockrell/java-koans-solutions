...
public class AboutArrays {
    ...
    public void arraysDoNotConsiderElementsWhenEvaluatingEquality() {
        ...
        assertEquals(new int[] { 1 }.equals(new int[] { 1 }), false); // do not compare one array to another using
                                                                      // arr1.equals(arr2) or == unless testing for same
                                                                      // instance
                                                                      // Arrays.equals(arr1, arr2) does check for values
                                                                      // however
    }
    ...
    // basically use ARRAYS class to test for arrays, not the arrays themselves
    ...
    public void arraysAreMutable() {
        ...
        // like python or c# lists, not c# arrays
    }
