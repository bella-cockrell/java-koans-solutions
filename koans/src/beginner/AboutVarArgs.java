...
public class AboutVarArgs {
    ...
    class ExampleClass {
        ...
        // *******
        // The following methods won't compile because Java only permits varargs as last
        // argument
        // *******
        // public String invalidMethodDeclaration(String... arguments, String...
        // otherArguments) { return ""; }
        // public String otherInvalidMethodDeclaration(String... arguments, String
        // otherArgument) { return ""; }
    }
