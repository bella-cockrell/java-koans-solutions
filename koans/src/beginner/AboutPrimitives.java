...
public class AboutPrimitives {
    ...
    public void primitivesOfTypeLongHaveAnObjectTypeLong() {
        Object number = 1L;
        assertEquals(getType(number), Long.class); // whats the difference between getType (it is the declared
                                                   // value) and getClass (runtime value)?
    }
    ...
    public void longSize() {
        assertEquals(Long.SIZE, 64); // int32, long64
    }
    ...
    public void shortSize() {
        assertEquals(Short.SIZE, 16); // int32, long64, short16
    }
    ...
    public void bytesHaveASmallerRangeThanShorts() {
        ...
        // primitive int can be handled by Integer, Long, Float etc.
        // But because short and byte hold less memory, you need to explicitly say you
        // want to cast
        // because of possible memory loss
    }
    ...
    public void wholeNumbersCanAlsoBeOfTypeChar() {
        assertEquals(getType((char) 1), char.class); // oh cool!
    }
    ...
    public void charsAreNotNegative() {
        ...
        // System.out.println(Character.MAX_VALUE); //￿ -- couldnt read the character
    ...
    @Koan
    public void primitivesOfTypeDoubleCanBeDeclaredWithExponents() { // exponents are doubles
    ...
    public void doubleSize() {
        assertEquals(Double.SIZE, 64); // int32 long64 double64 byte8 short16
    }

    @Koan
    public void decimalNumbersCanAlsoBeOfTypeFloat() {
        assertEquals(getType(1f), float.class); // doubles can contain more numbers than float
    }
