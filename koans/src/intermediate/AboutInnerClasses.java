...
public class AboutInnerClasses {
    ...
    public void creatingAnonymousInnerClasses() {
        AboutInnerClasses anonymous = new AboutInnerClasses() {
          ...
          // add semicolon to complete block statements
        assertEquals(anonymous.theAnswer(), 23); // I think it prioritises inner props
    }
    ...
    public void innerClassAndInheritance() {
        ...
        assertEquals(someObject instanceof Inner, true); // that inner classes do not mean inheritance
    }
    ...
    public void innerClassAndInheritanceOther() {
        ...
        assertEquals(someObject instanceof AboutInnerClasses, true); // true because it is extended
    }
