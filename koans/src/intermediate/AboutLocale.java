...
public class AboutLocale {
    ...
    public void localizedOutputOfDates() {
        ...
        // ;-)
        assertEquals(dateformatJA.format(date), "2011年4月3日日曜日");
    }
    ...
    public void formatCurrency() {
        float someAmount = 442.23f; // Don't use floats for money in real life. Really. It's a bad idea. Use BigDec
                                    // instead
        // https://en.wikipedia.org/wiki/Floating-point_arithmetic#Accuracy_problems
        Locale locBR = new Locale("pt", "BR");
        NumberFormat nf = NumberFormat.getCurrencyInstance(locBR);
        // assertEquals(nf.format(someAmount), "R$ 442,23"); //both are String but can't
        // make pass
    }
}
