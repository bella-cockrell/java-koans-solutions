...
public class AboutLambdas {
    ...
    Caps thisLambdaField = s -> this.toString(); // toString overridden in the class
    // lambda has access to object methods
    Caps toStringLambdaField = s -> toString(); // normal toString? Nope looks like both refer to overriden

    @Koan
    public void verySimpleLambda() throws InterruptedException {
        Runnable r8 = () -> str = "changed in lambda"; // concurrency
        r8.run();
